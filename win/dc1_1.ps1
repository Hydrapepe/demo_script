...
Set-GPRegistryValue -Name "Warning" -Key "HKLM\Software\Policies\Microsoft\Windows\ADR\AccessDenied" -ValueName ErrorMessage -Type MultiString -Value "Please, don't do that - [Original File Path]! We should call to FBR!"
