...
echo -e '\033[0;31m !!!!!!!!!!!!!!! Postav ip 192.168.10.2 mask 30 na ens192, gateway 192.168.10.1, dns 172.16.20.10, domain demo2020.wsr \033[0m'
echo -e '\033[0;31m !!!!!!!!!!!!!!! Postav ip 192.168.100.1 mask 24 na ens224, gateway ne nado, dns 172.16.20.10, domain demo2020.wsr \033[0m'